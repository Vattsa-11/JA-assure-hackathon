...
from app.models.content import ContentVersion, Feedback
...
def prove_feedback_loop():
    ...
    try:
        ...
        target_asset = next(a for a in initial_assets if a.platform == "linkedin")
        ...
        new_target_asset = next(a for a in new_assets if a.platform == "linkedin")
